    ...
    return (
        <div className={classes.termsPaper}>
            <div className={classes.termsBody}>
                ...
                <Typography variant="body1" gutterBottom>
                    We want to inform you that whenever you visit our Service, we collect information that your browser sends to us that is called Log Data. This Log Data may include information such as your computer's Internet Protocol (“IP”) address, browser version, pages of our Service that you visit, the time and date of your visit, the time spent on those pages, and other statistics. We also want to inform you that your login session is handled by Google, and thus more data may be collected by them.
                </Typography>
                <Typography variant="h5" gutterBottom>
                    Cookies
                </Typography>
                ...
                <Typography variant="body1" gutterBottom>
                    If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us using the following email: <a href="mailto:marcel.bruna@epistula-electronica.de"> marcel.bruna@epistula-electronica.de </a>
                </Typography>
            </div>
